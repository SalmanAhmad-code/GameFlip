    ...
    return (
        ...
        <div className="card-client bg-slate-200 dark:bg-slate-900 !bg-opacity-50">
            <div className="user-picture">
                <img src={'/Salman.jpg'} alt="SalmanDP" />
            </div>
            <p className="name-client"> Salman Ahmad
                <span>Front end and UI design Lead Engineer
                </span>
            </p>
            <div className="social-media">
                <div className=' flex flex-row justify-center items-center'>
                    <a href="https://salmanahmad-code.github.io/portfolio-web/">
                    ...
                    <a href="https://github.com/SalmanAhmad-code">
                    ...
                    <a href="https://www.linkedin.com/in/salman-ahmad-398274290/">
