...
export default function RayanCard() {
    return (
        /* From Uiverse.io by abrahamcalsin */
        <div className="card-client bg-slate-200 dark:bg-slate-900 !bg-opacity-50">
            <div className="user-picture">
                <img src={'/Rayan.jpg'} alt="RayanDP" />
            </div>
            <p className="name-client"> Muhammad Rayan
                <span>Backend Developer<br />&nbsp;
                </span>
            </p>
            <div className="social-media">
                <div className=' flex flex-row justify-center items-center'>
                    <a href="https://i-raycoder.github.io/iraycoder.github.io/">
                    ...
                    <a href="https://github.com/i-raycoder">
                    ...
                    <a href="https://www.linkedin.com/in/muhammad-rayan-30604b252/">
