...
export default function KanikaCard() {
    return (
        /* From Uiverse.io by abrahamcalsin */
        <div className="card-client bg-slate-200 dark:bg-slate-900 !bg-opacity-50">
            <div className="user-picture">
                <img src="https://media.licdn.com/dms/image/v2/D5603AQGqwMWVyzxW7A/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1718276742198?e=1729123200&v=beta&t=vnpJe8wMezaZ__XvSljqvbuxnEudAS0Il3PWh7DcvqM" alt="KanikaDP" />
            </div>
            <p className="name-client"> Kanika Khosla
                <span>Backend and Technical Engineer<br />&nbsp;
                </span>
            </p>
            <div className="social-media">
                <div className=' flex flex-row justify-center items-center'>
                    ...
                    <a href="https://github.com/kanikakoff">
                    ...
                    <a href="https://www.linkedin.com/in/kanika-khosla-5b4215209/">
