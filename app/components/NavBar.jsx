        ...
        <div className="press-start-2p-regular h-20 bg-[#151515] w-full flex flex-row justify-evenly items-center">
            ...
            <ul>
                <li className="flex flex-row justify-center items-center">
                    <span className="w-screen md:w-[130%] h-10 bg-gray-200 cursor-pointer border border-gray-300 text-sm flex p-2">
                        <input type="search" name="serch" placeholder="Search"
                            className="bg-[#F3F8FF] flex-grow px-4 text-xs focus:outline-none" />
                    </span>
                    <span className="w-screen md:w-[130%] h-10 bg-gray-200 cursor-pointer border border-gray-300 text-sm flex"><i className="fas fa-search m-3 mr-5 text-lg text-gray-700 w-4 h-4" /></span>
                </li>
            </ul>
